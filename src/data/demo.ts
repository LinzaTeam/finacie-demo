...
export const demoDashboard: DashboardData = {
  ...
  categories: [
    ...
    { id: "coffee", label: "Кофе", iconKey: "coffee", color: "#C7A9D8", amountMinor: 0, currency: "RUB", share: 0 },
    { id: "cafe_delivery", label: "Кафе и доставка", iconKey: "utensils", color: "#E7C06D", amountMinor: 0, currency: "RUB", share: 0 },
    { id: "transport", label: "Транспорт и такси", iconKey: "tram-front", color: "#95B1EE", amountMinor: 18_460_20, currency: "RUB", share: 0.143 },
    ...
    { id: "entertainment", label: "Развлечения", iconKey: "gamepad-2", color: "#95B1EE", amountMinor: 0, currency: "RUB", share: 0 },
    { id: "gifts", label: "Подарки", iconKey: "gift", color: "#D99A9A", amountMinor: 0, currency: "RUB", share: 0 },
    { id: "business", label: "Бизнес", iconKey: "briefcase-business", color: "#364C84", amountMinor: 0, currency: "RUB", share: 0 },
    { id: "services", label: "Сервисы", iconKey: "server", color: "#364C84", amountMinor: 16_992_00, currency: "RUB", share: 0.132 },
    { id: "subscriptions", label: "Подписки AI", iconKey: "repeat-2", color: "#C7A9D8", amountMinor: 0, currency: "RUB", share: 0 },
    { id: "tobacco", label: "Табак", iconKey: "receipt", color: "#333333", amountMinor: 0, currency: "RUB", share: 0 },
